        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('admin.home') }}" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{ asset('/') }}logo/LogoDigiCodein.png" alt="logo"></span>
                    <span class="logo-sm"><img src="{{ asset('/') }}logo/LogoDigiCodein.png" alt="small logo"></span>
                </span>

                <span class="logo-dark">
                    <span class="logo-lg"><img src="{{ asset('/') }}logo/LogoDigiCodein.png" alt="dark logo"></span>
                    <span class="logo-sm"><img src="{{ asset('/') }}logo/LogoDigiCodein.png" alt="small logo"></span>
                </span>
            </a>
            ...
            <div class="topbar-item">
                <div class="dropdown">
                    <button class="topbar-link" data-bs-toggle="dropdown" data-bs-offset="0,32" type="button"
                        ...
                        <img src="{{ asset('/') }}assets/images/flags/us.svg" alt="user-image" class="w-100 rounded" height="18"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en">
                            <img src="{{ asset('/') }}assets/images/flags/us.svg" alt="user-image" class="me-1 rounded" height="18"
                                data-translator-image> <span class="align-middle">English</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi">
                            <img src="{{ asset('/') }}assets/images/flags/in.svg" alt="user-image" class="me-1 rounded" height="18"
                                data-translator-image> <span class="align-middle">Hindi</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('/') }}assets/images/flags/de.svg" alt="user-image" class="me-1 rounded" height="18">
                            <span class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('/') }}assets/images/flags/it.svg" alt="user-image" class="me-1 rounded" height="18">
                            <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="{{ asset('/') }}assets/images/flags/es.svg" alt="user-image" class="me-1 rounded" height="18">
