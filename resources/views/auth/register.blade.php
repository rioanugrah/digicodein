        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <h4 class="fw-semibold mb-2 fs-18">{{ __('Daftar Akun') }}</h4>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="text-start mb-3">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-primary-new fw-semibold" type="submit">Daftar Sekarang</button>
                        </div>
                    </form>

                    <p class="text-muted fs-14 mb-4">Sudah Memiliki Akun? <a href="{{ route('login') }}"
                            class="fw-semibold text-danger ms-1">Login Sekarang</a></p>
