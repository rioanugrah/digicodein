...
Route::get('testing/wa', [App\Http\Controllers\TestingController::class, 'twilioWA']);
Route::get('testing/sms', [App\Http\Controllers\TestingController::class, 'twilioSms']);
